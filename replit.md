...
- **Alert Types:**
    ...
    - **Volatility Alerts:** Detects significant price swings (default 20%+ within configurable time window) using in-memory tracking. Features a 15-minute warm-up period after bot restart to prevent false alerts from seeded data. Category filtering available (All, Sports, Crypto, Politics, Entertainment).
